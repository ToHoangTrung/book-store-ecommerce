...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleConcurrentUpdate(ConcurrentUpdateException e) {
        ExceptionResponse exceptionResponse = new ExceptionResponse(e.getMessage(), ClosureEcommerceErrorCode.CONCURRENT_UPDATE_EXCEPTION, HttpStatus.CONFLICT);
    ...
    public ResponseEntity<Object> handleValidationExceptions(MethodArgumentNotValidException ex) {
        ...
        ExceptionResponse exceptionResponse = new ExceptionResponse("The following input type is incorrect", ClosureEcommerceErrorCode.UN_HANDLE_EXCEPTION, HttpStatus.CONFLICT, errors);
        return new ResponseEntity<>(exceptionResponse, HttpStatus.CONFLICT);
    }
    ...
    protected ResponseEntity<Object> handleGenericException(Exception ex) {
        ...
        ExceptionResponse exceptionResponse = new ExceptionResponse(ex.getMessage(), ClosureEcommerceErrorCode.UN_HANDLE_EXCEPTION, HttpStatus.BAD_REQUEST);
